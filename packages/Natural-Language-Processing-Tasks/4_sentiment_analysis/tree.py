...
def simplified_data(num_train, num_dev, num_test):
    ...
    num_dev/=2
    num_test/=2
    train = pos_trees[:int(num_train)] + neg_trees[:int(num_train)]
    dev = pos_trees[int(num_train) : int(num_train)+int(num_dev)] + neg_trees[int(num_train) : int(num_train)+int(num_dev)]
    test = pos_trees[int(num_train)+int(num_dev) : int(num_train)+int(num_dev)+int(num_test)] + neg_trees[int(num_train)+int(num_dev) : int(num_train)+int(num_dev)+int(num_test)]
