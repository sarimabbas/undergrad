...
(2)$ (2)$ (2)$ 			   Useful Valgrind Options$$$$$
			   ~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
--log-file=<filename>$$$$$
 Specifies that Valgrind should send all of its messages to the specified file.$$$$$
 If the file name is empty, it causes an abort.  There are three special format$$$$$
...
$$$$$
 Pressing Ret, or N Ret or n Ret, causes Valgrind not to start a debugger for$$$$$
 this error.$$$$$
$$$$$
 Pressing Y Ret or y Ret causes Valgrind to start a debugger for the program at$$$$$
 this point.  When you have finished with the debugger, quit from it, and the$$$$$
 program will continue.  Trying to continue from inside the debugger doesn't$$$$$
 work.$$$$$
$$$$$
-q, --quiet$$$$$
...
subst (Subst14.c:194) means Line 194 in file Subst14.c in the function subst().$$$$$
...
==15874==    by 0x400A9E: main (Subst14.c:79)$$$$$
$$$$$
At least one argument in the call to strstr() at Subst14.c:79 was never$$$$$
assigned a value.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
==30047== Invalid read of size 1$$$$$
==30047==    at 0x400C44: main (Subst14.c:88)$$$$$
...
==30047==    by 0x400C24: main (Subst14.c:86)$$$$$
$$$$$
The statement at main (Subst14.c:88) is attempting to read the first byte$$$$$
following the end of the block of storage that was realloc()-ed on Line 86.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
==31573== Invalid read of size 1$$$$$
==31573==    at 0x4016A3: nextProg (Subst14.c:228)$$$$$
...
==31573==    by 0x400DFE: nextProg (Subst14.c:133)$$$$$
$$$$$
The statement at nextProg (Subst14.c:228) is attempting to read the byte$$$$$
...
==11644==    by 0x401204: main (Subst14.c:154)$$$$$
...
==11644==    by 0x4013BB: subst (Subst14.c:194)$$$$$
$$$$$
The statement at main (Subst14.c:154) called puts(), which begins by finding$$$$$
...
==5932==    at 0x401DD9: swap (Subst14.c:378)$$$$$
...
==5932==    by 0x401D60: swap (Subst14.c:374)$$$$$
$$$$$
The statement at swap (Subst14.c:378) is trying to read a byte inside a block$$$$$
...
==677==    at 0x400832: stringSize (Subst14.c:15)$$$$$
...$$$$$
==677==  Address 0x0 is not stack'd, malloc'd or (recently) free'd$$$$$
$$$$$
The statement at stringSize (Subst14.c:15) is attempting to dereference a$$$$$
NULL pointer.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
...
==29188==    by 0x400B90: main (Subst14.c:121)$$$$$
==29188==  Address 0x0 is not stack'd, malloc'd or (recently) free'd$$$$$
$$$$$
One argument in the call to to strcmp() at main (Subst14.c:121) has the$$$$$
value NULL.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
...
==2149==    by 0x402800: findStringIndex (Subst14.c:528)$$$$$
...$$$$$
==2149==  Address 0x740 is not stack'd, malloc'd or (recently) free'd$$$$$
$$$$$
One argument in the call to to strstr() at findStringIndex (Subst14.c:528)$$$$$
does not point to a null-terminated string.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
==30206== Conditional jump or move depends on uninitialised value(s)$$$$$
==30206==    at 0x400CBA: main (Subst14.c:90)$$$$$
$$$$$
Some value in the conditional expression at main (Subst14.c:90) was never$$$$$
initialized.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
...
==11091==    by 0x401BB5: replace (Subst14.c:311)$$$$$
$$$$$
...
the call at replace (Subst14.c:311) is not null-terminated.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
...
==26935==    by 0x400D97: main (Subst14.c:182)$$$$$
$$$$$
...
(Subst14.c:182) is not null-terminated.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
...
==30760==    by 0x40131F: main (Subst14.c:200)$$$$$
$$$$$
...
==29559==    by 0x4011CC: replace (Subst14.c:235)$$$$$
...
==29559==    by 0x4011A9: replace (Subst14.c:234)$$$$$
$$$$$
The call to strncpy() at replace (Subst14.c:235) is trying to copy more chars$$$$$
than the size of the block allocated at replace (Subst14.c:234) can hold,$$$$$
...
==5320==    by 0x40146F: s (Subst14.c:334)$$$$$
...
==5320==    by 0x40142D: s (Subst14.c:325)$$$$$
$$$$$
The first argument in the call to strncpy() at s (Subst14.c:334) is a pointer$$$$$
to a block that was free()-ed at s (Subst14.c:325).$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
==31365== Invalid write of size 1$$$$$
==31365==    at 0x4C2BBAC: strcpy (in /usr/lib64/valgrind/vgpreload_mem...)$$$$$
==31365==    by 0x400E2E: subst (Subst14.c:171)$$$$$
==31365==  Address 0x0 is not stack'd, malloc'd or (recently) free'd$$$$$
$$$$$
The value of the first argument to strcpy() at subst (Subst14.c:171) is the$$$$$
NULL pointer.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
...
==5750==    by 0x401069: strbufAppend (Subst14.c:102)$$$$$
...$$$$$
==5750==  Address 0x4ffffe is not stack'd, malloc'd or (recently) free'd$$$$$
$$$$$
The value of the first argument to strcpy() at strbufAppend (Subst14.c:102) is$$$$$
not a pointer to a block of storage.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
==1894== Invalid write of size 8$$$$$
==1894==    at 0x40096B: main (Subst14.c:34)$$$$$
...
==1894==    by 0x40090A: main (Subst14.c:31)$$$$$
$$$$$
A block of storage for a pointer array was allocated at main (Subst14.c:31)$$$$$
but the size was not a multiple of 8 (= sizeof(anytype*)).  The attempt to$$$$$
store a pointer in that array at main (Subst14.c:34) ran off the end of the$$$$$
block.$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
$$$$$
...
==7331==    by 0x4012F0: parseEscape (Subst14.c:108)$$$$$
...
==7331==    by 0x401654: replace (Subst14.c:151)$$$$$
$$$$$
The first argument to realloc() at parseEscape (Subst14.c:108) was a pointer$$$$$
into the middle of the block that was allocated at replace (Subst14.c:151).$$$$$
$$$$$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$$$$$
								CS-223-02/11/14$$$$$
(3)$ End of test
